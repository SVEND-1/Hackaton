package org.example.todolist.users.domain;

import jakarta.servlet.http.HttpServletResponse;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.todolist.config.JwtTokenProvider;
import org.example.todolist.notify.EmailSenderService;
import org.example.todolist.notify.event.NotifyEvent;
import org.example.todolist.notify.event.NotifyType;
import org.example.todolist.notify.kafka.NotifyKafkaProducer;
...
import org.example.todolist.users.api.dto.auth.response.LoginResponse;
import org.example.todolist.users.api.dto.auth.response.PasswordResetResponse;
import org.example.todolist.users.api.dto.auth.response.RegistrationResponse;
import org.example.todolist.users.api.dto.auth.response.SimpleResponse;
...
import org.example.todolist.users.domain.mapper.UserMapper;
